...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override init() {
        ...
        self.setValue(NSValue(cgRect: pageFrame.insetBy(dx: 2.0, dy: 2.0)), forKey: "printableRect")
        
        self.headerHeight = 60.0
        self.footerHeight = 60.0
    }
    
    
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
        // Specify the header text.
        let headerText: NSString = "Expense Report"
        ...
        let pointY = headerRect.size.height/2 - textSize.height/2 + 2
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        let font = fontPopins.Regular.of(size: 12)
