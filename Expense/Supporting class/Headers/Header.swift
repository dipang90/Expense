...
struct Expense {
    static var strGlobalUserid : String!
    static var strGlobalUtokenID : String!
    static var screenWidth : CGFloat = 0
    static  var screenHeight : CGFloat = 0
    static var strGlobalReportId = ""
    static var strGlobalReortName = ""
    static var strGlobalDateFormate  = "dd/MM/yyyy"
}
